...
class QuizBrain{
  ...
  String getQuestionAsNumber(){
    return _QuestionData[_qNumber].QuestionText;
  }

  bool getAnswerAsQues(){
    return _QuestionData[_qNumber].QuestionsAns;
  }

  void nextQuestion(){
    if(_qNumber < _QuestionData.length - 1 ){
        _qNumber++ ;
    }
  }
  bool isFinished() {
